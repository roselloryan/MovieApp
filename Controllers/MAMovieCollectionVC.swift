//
//  MAMovieCollectionVCCollectionViewController.swift
//  MovieApp
//
...
class MAMovieCollectionVC: UICollectionViewController {
    ...
    */
    ...
    @objc func filterButtonTapped(_ barButton: UIBarButtonItem) {
        ...
        let storyboard = UIStoryboard(name: Constants.Identifiers.MainStoryboardName, bundle: nil)

        if var filterVC = storyboard.instantiateViewController(withIdentifier: Constants.Identifiers.FilterTableVC) as? MAFiltersTableVC {
            filterVC.view.frame = CGRect.init(x: 0, y: 0, width: 100, height: 100)
//            view.addSubview(filterVC)
        }
    }
}

extension MAMovieCollectionVC: UICollectionViewDelegateFlowLayout {
